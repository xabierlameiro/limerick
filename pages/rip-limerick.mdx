...
export const meta = {
    title: "Rip.ie Limerick - Rent in partner",
    description: "Rip.ie Limerick, Rent in partner",
};

# Rip.ie Limerick - Rent in partner
...
Rip.ie Limerick (Rent in partner). I will be writing about the difficulties of renting a property in Ireland in the current times.
...
> If you would like to contact us, please go to <Link href="/#contact" scroll={false}><a title="Contact link anchor">contact</a></Link>.
