  ...
  return<> <main>
    <Image
      ...
      <p>Nuestro objetivo es conocer Irlanda, aprender y prácticar inglés a la vez que seguimos con nuestra vida habitual, trabajar como programador en mi caso y
       ...
       <p>Llegaremos a Irlanda el 23 de Octubre de 2022 y tenemos alojamiento <span className={styles.underlined}>solo para 2 semanas.</span> <p>
       </p>Nos gustaría alquilar un apartamento de una habitación o un espacio en una vivienda compartida por esta zona si es posible:</p>
